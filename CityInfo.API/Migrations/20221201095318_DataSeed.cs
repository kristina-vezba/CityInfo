    ...
    public partial class DataSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Description", "Name" },
                values: new object[] { 2, "The one with the catedral taht was never really finished.", "Antwerp" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "The most visited park in the United States.", "Central Park" });
